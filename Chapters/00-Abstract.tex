...
to perform pixel-level classification on the 48x48 patches, assigning one of the 19 labels proposed by BigEarthNet to every pixel. This work aims to approach the utility BigEarthNet has 
for Spanish soil, with the ultimate purpose of enabling faster, more efficient, and automated updates of national land use maps in the future, or at least serving as a support tool.
}
