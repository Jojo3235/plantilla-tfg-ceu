...
automáticamente mediante fuentes disponibles como Catastro, \acrfull{sigpac} o la Información de la Declaración de Agricultores |\citet{siose.es}|.
...
aérea y mapeo de alta resolución del territorio |\citet{xcalibur}|, más concretamente de su departamento de \acrshort{ia} que buscaba entrenar un
